# Project Name : Credit Card Landing Page ![Tech Stack Used](https://img.shields.io/badge/Technologies-HTML%20%26%20CSS-orange)
...
- In this project, I have built a **Credit Card Landing Page** from the scratch using core `HTML` & `CSS`.
